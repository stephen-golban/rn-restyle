...
export type FlexDirectionValue = Omit<FlexStyle["flexDirection"], "column" | "column-reverse"> | "col" | "col-reverse";
...
export type LayoutProps<Theme extends BaseTheme> = StyleProps<Theme> & RestyleDimensions<Theme> & RestyleWrap & RestyleDirection & RestyleJustify & RestyleAlignItems & RestyleAlignContent & RestyleAlignSelf & RestylePositioning & RestyleFlexLayout;
